(function(_window_) {
		...
		this.load = function(word, speedInMillis) {
			...
			for (var i = 0; i < word.length; i++) {
				...
				if(characterTiles[j].character != " ") {
					var _B = new BrickObject(characterTile, "white");
	...
	var GameProperties = function() {
		...
		function showCharacters(character, x, y) {
			...
			var brickCharacter = new BrickObject(characterTile, "black");
	...
	function BrickObject(tiles, color, brickDirection) {
		...
		this.rotate = function(originX, originY, direction) {
