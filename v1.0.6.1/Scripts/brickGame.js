(function(_window_) {
	...
	},
	{
		...
		load: function() {
			// DECLARATIONS
			var level = brickGameModel.getLevel(), speedInMillis = brickGameModel.getSpeedInMillis();
			var soldierObject = new BrickObject({ tiles: getBrickTiles("soldierTile"), brickLocation: { x: 18, y: 4 } });
	...
	},
	{
		...
		load: function() {
			// DECLARATIONS
			var level = brickGameModel.getLevel(), speedInMillis = brickGameModel.getSpeedInMillis();
			var pinballCatcher = new BrickObject({ tiles: getBrickTiles("quadrupleTiles"), brickLocation: { x: 19, y: 3 } });
	...
	},
	{
		...
		load: function($game) {
			// DECLARATIONS
			var level = brickGameModel.getLevel(), speedInMillis = brickGameModel.getSpeedInMillis();
			var pinballCatcher1 = new BrickObject({ tiles: getBrickTiles("quadrupleTiles"), brickLocation: { x: 0, y: 3 } });
			var pinballCatcher2 = new BrickObject({ tiles: getBrickTiles("quadrupleTiles"), brickLocation: { x: 19, y: 3 } }); 
			var pinball = new BrickObject({ tiles: getBrickTiles("singleTile"), color: "Green", brickLocation: { x: 18, y: 5 }});
			var isPinballThrown = false;
			var pinballDirection = "BottomLeft";
			var params = {};
	...
	},
	{
		...
		load: function() {
			...
			// FUNCTIONS
			function addCrosser() { crosser = new BrickObject({ tiles: getBrickTiles("singleTile"), color: "Green" , brickLocation: { x: 19, y: 5 }}); }
			function loadWalls() {
	...
	},
	{
		...
		load: function() {
			...
			var snakeCrawlAnim = new Timer({ func: crawlSnake, interval: speedInMillis });
	...
	},
	{
		...
		load: function() {
			...
			var myCar = new BrickObject({ tiles: getBrickTiles("carTile"), brickLocation: { x: 16, y: 5 } });
			var moveRoadAnim = new Timer({ func: moveRoad, interval: speedInMillis });
			new BrickObject({ tiles: getBrickTiles("twentyByOne"), brickLocation: { x: 0, y: 0 } });
			new BrickObject({ tiles: getBrickTiles("twentyByOne"), brickLocation: { x: 0, y: 9 } });
